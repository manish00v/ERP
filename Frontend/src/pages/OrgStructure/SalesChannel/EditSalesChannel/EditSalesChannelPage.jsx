...
export default function EditSalesChannelForm({ initialData }) {
        ...
        switch (name) {
          case "salesChannelId":
            if (!/^[a-zA-Z0-9]{4}$/.test(value)) {
              return "Sales Channel Id Code must be exactly 4 alphanumeric characters";
            }
            break;
          case "entityName":
            if (value.length > 30 || !/^[a-zA-Z0-9 ]+$/.test(value)) {
              return "Sales Channel Id Name must be alphanumeric and up to 30 characters";
            }
            break;
          default:
            return "";
        ...
        <form id="salesChannelForm" onSubmit={handleSubmit}>
          ...
          <div className="header-box">
            ...
            <div className="data-container">
              ...
              <div className="data">
                <label htmlFor="description">Sales Channel Description*</label>
                <span className="info-icon-tooltip">
                  <i className="fas fa-info-circle" />
                  <span className="tooltip-text">
